...
class Antrian extends CI_Controller
{
    ...
    {
        $data['last_antrian'] = $this->getLastAntrian(date("Y-m-d"), '16');
        // echo "<pre/>";
        // print_r($data);
    ...
    {
        $lastAntrian = $this->antrian_poli_model->getLastAntrian($date, $id);
    ...
    public function refreshTable()
    {
        ...
        $last_antrian = $this->antrian_poli_model->getLastAntrian(date("Y-m-d"), '16');
