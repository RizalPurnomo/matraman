		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index3.html" class="brand-link">
				...
				<span class="brand-text font-weight-light">Matraman</span>
			</a>
               ...
               with font-awesome or any other icon font library -->
						<li class="nav-item menu-open">
							...
							<ul class="nav nav-treeview">
								...
								<li class="nav-item">
									<a href="<?php echo base_url('admin/skp'); ?>" class="nav-link">
										<i class="far fa-circle nav-icon"></i>
										<p>List SKP</p>
									</a>
								</li>
								<li class="nav-item">
									<a href="<?php echo base_url('admin/skp/kpi'); ?>" class="nav-link active">
										<i class="far fa-circle nav-icon"></i>
										<p>Laporan KPI</p>
									</a>
								</li>
