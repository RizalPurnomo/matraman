...
<body class="hold-transition layout-top-nav">
                                ...
                                <div class="card card-success card-outline" id="div_umum" style="display:none">
                                    <div class="card-body">
                                        ...
                                        <button type="button" class="btn btn-block bg-gradient-success btn-lg" id="print_umum">
                                            <h1><i class="fa fa-print"></i> Cetak Antrian Umum</h1>
                                        </button>
                                        <br />
                                ...
                                <div class="card card-warning card-outline" id="div_lansia" style="display: none;">
                                    <div class="card-body">
                                        ...
                                        <button type="button" class="btn btn-block bg-gradient-warning btn-lg" id="print_lansia">
                                            <h1><i class="fa fa-print"></i> Cetak Antrian prioritas</h1>
                                        </button>
                        ...
                        <div class="col-lg-3">
                            <div class="card card-primary card-outline">
                                <div class="card-body">
                                    ...
                                    <button type="button" class="btn btn-block btn-outline-primary" id="back">Pilih Poli</button>
                                    <input type="hidden" id="is_umum" value="<?php echo $is_umum ?>">
                                    <input type="hidden" id="is_lansia" value="<?php echo $is_lansia ?>">
    ...
    <script>
        ...
        window.onload = function() {
            ...
            // alert('dsd');
            // div_lansia.style.display = 'block';
            if ($("#is_umum").val() == 1) {
                $("#div_umum").slideDown("slow");
            }
            if ($("#is_lansia").val() == 1) {
