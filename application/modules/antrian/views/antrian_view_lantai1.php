...
<head>
    ...
    <title>Antrian Lantai 1| Poli</title>
        ...
        <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
            <div class="container">
                <a href="<?php echo base_url(); ?>index3.html" class="navbar-brand">
                    ...
                    <span class="brand-text font-weight-light">LANTAI 1</span>
                </a>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">ANTRIAN <small>LANTAI 1</small></h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                        ...
                        <div class="col-lg-12">
                            <div class="card card-success card-outline">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div id="div_ket_umum" class="alert alert-success alert-dismissible" style="display:none;">
                                        ...
                                        <div class="col-lg-4">
                                            <div id="div_ket_up24" class="alert alert-success alert-dismissible" style="display:none;">
                                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                                <h4><i class="icon fa fa-info"></i> <span id="judul_ket_up24"></span></h4>
                                                <p id="ket_up24"></p>
                                            </div>
                                            <div class="card card-primary card-outline" style="text-align: center;">
                                                <div class="card-header">
                                                ...
                                                <div class="card-body">
                                                    <h1><b><span id="no_antrian_up24"><?php echo $no_antrian_up24; ?></span></b></h1>
                                                </div>
                                            </div>
                                        </div>

                                        <div class="col-lg-4">
                                            <div id="div_ket_tb" class="alert alert-success alert-dismissible" style="display:none;">
                                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                                <h4><i class="icon fa fa-info"></i> <span id="judul_ket_tb"></span></h4>
                                                <p id="ket_tb"></p>
                                            </div>
                                            <div class="card card-primary card-outline" style="text-align: center;">
                                                <div class="card-header">
                                                ...
                                                <div class="card-body">
                                                    <h1><b><span id="no_antrian_tb"><?php echo $no_antrian_tb; ?></span></b></h1>
                                                </div>
                                            </div>
                                        </div>

                                        <div class="col-lg-4">
                                            <div id="div_ket_lansia" class="alert alert-success alert-dismissible" style="display:none;">
                                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                        ...
                                        <div class="col-lg-4">
                                            <div id="div_ket_ispa" class="alert alert-success alert-dismissible" style="display:none;">
                                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                                <h4><i class="icon fa fa-info"></i> <span id="judul_ket_ispa"></span></h4>
                                                <p id="ket_ispa"></p>
                                            </div>
                                            <div class="card card-primary card-outline" style="text-align: center;">
                                                <div class="card-header">
                                                ...
                                                <div class="card-body">
                                                    <h1><b><span id="no_antrian_ispa"><?php echo $no_antrian_ispa; ?></span></b></h1>
                                                </div>
                                            </div>
                                        </div>
...
<script>
    ...
    function setCardPoli(id_poli, no_antrian) {
        if (id_poli == "1") {
            $("#no_antrian_umum").html(no_antrian);
            ...
            $("#no_antrian_up24").html(no_antrian);
            $('#judul_ket_up24').html('Berhasil');
            $('#ket_up24').html('Berhasil dipanggil');
            $('#div_ket_up24').show();
            $("#div_ket_up24").fadeTo(1500, 500).slideUp(500, function() {
                $("#div_ket_up24").hide();
            });

        } else if (id_poli == "7") {
            $("#no_antrian_tb").html(no_antrian);
            $('#judul_ket_tb').html('Berhasil');
            $('#ket_tb').html('Berhasil dipanggil');
            $('#div_ket_tb').show();
            $("#div_ket_tb").fadeTo(1500, 500).slideUp(500, function() {
                $("#div_ket_tb").hide();
            });
        } else if (id_poli == "8") {
            ...
            $("#no_antrian_ispa").html(no_antrian);
            $('#judul_ket_ispa').html('Berhasil');
            $('#ket_ispa').html('Berhasil dipanggil');
            $('#div_ket_ispa').show();
            $("#div_ket_ispa").fadeTo(1500, 500).slideUp(500, function() {
                $("#div_ket_ispa").hide();
            });
        }
    }
    ...
    function refreshListAntrian() {
        ...
        $.ajax({
            ...
            // data: dataArray,
            dataType: "html",
            url: '<?php echo base_url('antrian/lantai1/refreshTableLantai1'); ?>',
