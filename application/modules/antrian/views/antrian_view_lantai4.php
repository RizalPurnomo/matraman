...
<head>
    ...
    <title>Antrian Lantai 4| Poli</title>
        ...
        <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
            <div class="container">
                <a href="<?php echo base_url(); ?>index3.html" class="navbar-brand">
                    ...
                    <span class="brand-text font-weight-light">LANTAI 4</span>
                </a>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">ANTRIAN <small>LANTAI 4</small></h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                        ...
                        <div class="col-lg-12">
                            <div class="card card-success card-outline">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div id="div_ket_dewasa1" class="alert alert-success alert-dismissible" style="display:none;">
                                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                                <h4><i class="icon fa fa-info"></i> <span id="judul_ket_dewasa1"></span></h4>
                                                <p id="ket_dewasa1"></p>
                                            </div>
                                            <div class="card card-primary card-outline" style="text-align: center;">
                                                ...
                                                <div class="card-body">
                                                    <h1><b><span id="no_antrian_dewasa1"><?php echo $no_antrian_dewasa1; ?></span></b></h1>
                                                </div>
                                            </div>

                                        </div>
                                        <div class="col-lg-4">
                                            <div id="div_ket_dewasa2" class="alert alert-success alert-dismissible" style="display:none;">
                                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                                <h4><i class="icon fa fa-info"></i> <span id="judul_ket_dewasa2"></span></h4>
                                                <p id="ket_dewasa2"></p>
                                            </div>
                                            <div class="card card-primary card-outline" style="text-align: center;">
                                                <div class="card-header">
                                                ...
                                                <div class="card-body">
                                                    <h1><b><span id="no_antrian_dewasa2"><?php echo $no_antrian_dewasa2; ?></span></b></h1>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div id="div_ket_dewasa3" class="alert alert-success alert-dismissible" style="display:none;">
                                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                                <h4><i class="icon fa fa-info"></i> <span id="judul_ket_dewasa3"></span></h4>
                                                <p id="ket_dewasa3"></p>
                                            </div>
                                            <div class="card card-primary card-outline" style="text-align: center;">
                                                <div class="card-header">
                                                ...
                                                <div class="card-body">
                                                    <h1><b><span id="no_antrian_dewasa3"><?php echo $no_antrian_dewasa3; ?></span></b></h1>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div id="div_ket_kb" class="alert alert-success alert-dismissible" style="display:none;">
                                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                                <h4><i class="icon fa fa-info"></i> <span id="judul_ket_kb"></span></h4>
                                                <p id="ket_kb"></p>
                                            </div>
                                            <div class="card card-primary card-outline" style="text-align: center;">
                                                <div class="card-header">
                                                ...
                                                <div class="card-body">
                                                    <h1><b><span id="no_antrian_kb"><?php echo $no_antrian_kb; ?></span></b></h1>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                        ...
                                        <div class="col-lg-4">
                                            <div id="div_ket_catin" class="alert alert-success alert-dismissible" style="display:none;">
                                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                                <h4><i class="icon fa fa-info"></i> <span id="judul_ket_catin"></span></h4>
                                                <p id="ket_catin"></p>
                                            </div>
                                            <div class="card card-primary card-outline" style="text-align: center;">
                                                <div class="card-header">
                                                ...
                                                <div class="card-body">
                                                    <h1><b><span id="no_antrian_catin"><?php echo $no_antrian_catin; ?></span></b></h1>
                                                </div>
                                            </div>
                                        </div>
